...
const words = ['head', 'feed', 'lean', 'meat', 'meet', 'flee', 'line', 'fine', 'wine', 'nine', 'dime', 'sign', 'port', 'love', 'hate', 'late', 'date', 'form', 'burn', 'done', 'hurt', 'turn', 'worn', 'wear', 'tear', 'fear', 'dear', 'beer', 'bear', 'hear', 'heed', 'cake', 'gate', 'fate', 'mate', 'know', 'fold', 'fall'];
